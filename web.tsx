  ...
  const t = {
    ko: {
      ...
      hero: {
        ...
        headline1: "당신의 언어로 일하세요.",
        headline2: "나머지는 저희가 할게요.",
        subheadline1: "한국어와 영어 팀을 위한 완전히 현지화된 협업 도구.",
        subheadline2: "언어 전환 없이 자연스럽게 소통하고, 작성하고, 작업하세요.",
        ctaStart: "무료로 시작하기",
        caption: "✨ 반복적인 노동 없이 글로벌 멤버와 커뮤니케이션하세요!",
      },
      social: {
        trusted: "전 세계 혁신적인 팀들의 신뢰",
        quote: "모두가 내 언어로 말하는 것 같아요.",
        role: "프로덕트 리드, TechFlow",
      },
      features: {
        title1: "✨ 반복적인 노동 없이",
        title2: " 글로벌 커뮤니케이션을!",
        subtitle: "언어 장벽 없이 자연스럽게 일하고 싶은 글로벌 팀을 위해 만들어졌습니다.",
        feature1Title: "네이티브 한국어 & 영어 경험",
        feature1Desc: "번역이 아 진짜 현지화. 모든 사용자는 자신의 언어로 완전한 네이티브 인터페이스를 봅니다.",
        feature2Title: "원활한 팀 협업",
        feature2Desc: "모두가 자신의 언어로 작업합니다. 전환도, 수동 번역도, 마찰도 없습니다.",
        feature3Title: "컨텍스트 인식 적응",
        feature3Desc: "시스템이 컨텍스트를 이해하고 전체 팀에 맞게 자동으로 적응합니다.",
        feature4Title: "워크플로우에 통합",
        feature4Desc: "Slack이나 Notion처럼 자연스럽게 통합됩니다. 익숙한 도구, 글로벌 언어 지원.",
      },
      howItWorks: {
        title: "빠른 설치와 실행",
        subtitle: "글로벌 협업을 위한 세 가지 간단한 단계",
        step1Title: "언어 선택",
        step1Desc: "가입할 때 한국어 또는 영어를 선택하세요. 그게 끝입니다 — 설정 완료.",
        step2Title: "평소처럼 작업",
        step2Desc: "작성하고, 댓글 달고, 협업하세요 — 모두 모국어로. 추가 단계 없음.",
        step3Title: "시스템이 자동으로 적응",
        step3Desc: "다른 모든 사람은 자신의 언어로 봅니다. 원활하고, 즉각적이며, 자동입니다.",
      },
      pricing: {
        title: "간단하고 투명한 가격",
      ...
      finalCta: {
        title1: "번역을 멈추세요.",
        title2: "일을 시작하세요.",
        subtitle: "언어를 생각하지 않고 글로벌하게 일하는 팀에 합류하세요.",
        startTrial: "무료 체험 시작",
        bookDemo: "데모 예약",
        footer: "신용카드 불필요 • 14일 무료 체험 • 언제든 취소 가능",
      },
      footer: {
