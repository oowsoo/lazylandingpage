  ...
  const t = {
    ko: {
      ...
      features: {
        ...
        feature2Desc: "우리팀이 번역기 돌리는 시간이 없어져요",
      ...
      howItWorks: {
        ...
        step2Desc: "지구상의 언어는 모두 지원해요",
        step3Title: "슬랙에서 나가지 마세요",
        step3Desc: "복붙하러 나갈 필요 없이 자동 번역!",
      },
      pricing: {
        title: "커피 두 잔 값으로 나른한 삶을 영위하세요",
        subtitle: "팀에 맞는 플랜을 선택하세요",
        basic: "Lazy",
        advanced: "Lazier",
        enterprise: "Laziest",
        perUser: "팀당/월",
        contactUs: "기업 맞춤 플러그인",
        mostPopular: "가장 인기",
        getStarted: "일단 써보기",
        basicFeatures: [
          "일단 써 보고 싶은 팀을 위한 플랜",
    ...
    en: {
      ...
      pricing: {
        ...
        advanced: "Lazier",
        enterprise: "Laziest",
        perUser: "per team/month",
        contactUs: "contact us",
        mostPopular: "Most Popular",
        getStarted: "Get Lazy Life",
        basicFeatures: [
