  ...
  const t = {
    ko: {
      ...
      features: {
        ...
        feature2Desc: "메시지가 뜨자마자 번역 메시지를 받을 것입니다.",
        feature3Title: "ㅅㅅ",
      ...
      howItWorks: {
        ...
        step1Title: "채널 설정",
        step1Desc: "번역기를 돌린다는 사실을 숨기고 싶다면, 별도 번역 채널을. 대놓고 번역해도 된다면, 글로벌 멤버가 있는 팀에 Lazy를 초대하세요!",
        step2Title: "전세계 언어 지원",
        step2Desc: "당신이 누구랑 대화하던, 번역해 드릴거에요. *우주인은 안 돼요.",
